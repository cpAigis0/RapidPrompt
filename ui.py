...
from PyQt5.QtWidgets import QApplication, QWidget, QHBoxLayout, QVBoxLayout, QLabel, QMainWindow, QSplitter, QScrollArea, QPushButton, QLineEdit, QFrame, QSplitterHandle, QSpinBox
...
class ToggleSwitch(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Start in dark mode: checked means dark mode active.
        self._checked = True  
        # Place circle on the right for dark mode.
...
class CustomSplitterHandle(QSplitterHandle):
    ...
    def paintEvent(self, event):
        ...
        # Draw two parallel lines (vertical if horizontal orientation, horizontal otherwise)
        line_thickness = 2
        gap = 3
        line_length = 20
        if self.orientation() == Qt.Horizontal:
            # For a horizontal splitter (vertical handle): draw two vertical lines.
            ...
            # For a vertical splitter (horizontal handle): draw two horizontal lines.
...
class SettingsMenu(QFrame):
    def __init__(self, parent=None):
        super().__init__(parent)
        # Set initial style to dark mode; will update via update_mode.
        self.update_mode(True)
        layout = QVBoxLayout(self)
        layout.setContentsMargins(10, 10, 10, 10)
        layout.setSpacing(20)
        # Title bar with close button (upper-right)
        ...
        # Stack controls vertically: reset button then toggle.
        ...
        # Add a spin box to control the number of text fields in part 3.
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Initial size: roughly half of 1920x1080 (960x540)
        self.resize(960, 540)
        # Define colors and initial mode BEFORE init_ui.
    ...
    def init_ui(self):
        ...
        # --- Splitter with three areas (using custom splitter for handle) ---
        self.splitter = CustomSplitter(Qt.Horizontal)
        # Part 1: Contains a QLineEdit for text input; no border.
        scroll1 = QScrollArea()
        ...
        # Part 2: Displays the text plainly without extra styling.
        scroll2 = QScrollArea()
        ...
        # Part 3: Contains text fields; starts with one empty text field.
        scroll3 = QScrollArea()
        ...
        self.part3_fields = []
        field = QLineEdit("")
        field.setStyleSheet("QLineEdit { background-color: #fff; border: 1px solid #888; padding: 3px; }")
        ...
        # Update Part 2 display when text input changes.
    ...
    def update_part3_fields(self, count):
        # Adjust the number of text fields in part 3.
    ...
    def resizeEvent(self, event):
        ...
        # Center the settings menu if visible.
        if self.settings_menu.isVisible():
